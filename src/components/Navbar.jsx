...
import { 
  ...
  Target, Wand2, Eye, Sparkle, Mail, Command
} from 'lucide-react';
      ...
      <div className="max-w-[1700px] mx-auto flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <div 
            ...
            className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/25 ring-1 ring-white/20 shrink-0 cursor-pointer group"
          >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider bg-blue-500/10 text-blue-300 border border-blue-500/30 flex items-center gap-1">
                ...
                <span>AI v2.0 • 22 Architectures</span>
              </span>
            </div>
          ...
          {onOpenCommandPalette && (
            <button
              ...
              className="hidden 2xl:flex items-center gap-2 px-2.5 py-1 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700 text-slate-300 hover:text-white text-xs transition-colors shadow-2xs ml-2"
        ...
        {/* Right Actions: AI Tools, Cover Letter, Template Gallery, Presets, ATS Score */}
        <div className="flex items-center gap-2">
          {/* AI Tools Quick Menu */}
              ...
              <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-slate-900 border border-slate-700 shadow-2xl p-2 z-50 text-xs space-y-1">
                ...
                {onOpenCoverLetter && (
                  ...
                  >
                    ...
                    <div>
                      <div className="font-bold text-white">Cover Letter Generator</div>
                      <div className="text-[11px] text-slate-400">Instant tailored companion document</div>
                    </div>
                  </button>
                )}
              </div>
